...
public class A_02_MyNumber implements A_02_IntOperations{
		...
		//No need to define any instance dm because value will come from method scope and resolute it.
		...
		//Prime number are those number which are divisible by their own number only.
