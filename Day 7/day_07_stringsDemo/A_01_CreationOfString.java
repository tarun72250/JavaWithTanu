...
public class A_01_CreationOfString {
	...
	{	
				...
				//String Literal 
				String str ="Suraj Rajput";//this reside in SCP
				//Both mean same
				//String creation Using new Keyword

				String str1 = new String("Learning Java in Morning Batch");//this reside in both SCP and Heap area 
				...
				//6 indexOf()
					    ...
					    int output1 = s.indexOf("Web");  // return 20 starting index number
			    ...
			    //8 equals()
					    ...
					    Boolean out3= "DebugShala".equalsIgnoreCase("debugShala"); // returns true check only char not upperCase and lowercase condition
			    ...
			    //9 toLowerCase() and toUpperCase()
					    ...
					    String word3 = word1.toLowerCase(); // returns sumit raghuwanshi"
					    System.out.println(word3);
					    String word2 = "sumit raghuwanshi";
					    String word4 = word2.toUpperCase(); // returns SUMIT RAGHUWANSHI
				...
				//12 startsWith(String prefix)
						...
						boolean startsWith1 = str.startsWith("Niraj");//str = "Suraj Rajput"
				        System.out.println("Starts with Suraj: " + startsWith1);//false
