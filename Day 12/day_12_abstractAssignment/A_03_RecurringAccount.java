...
public class A_03_RecurringAccount extends A_03_Account{
    ...
    public void calculateBalance() {
        double maturityAmt = recurringAmt * noOfInstallments;
        double interest = maturityAmt * intRate;
        balance = maturityAmt + interest;
    ...
    public void display() {
        super.display();
        System.out.println("Recurring Amount: ₹" + recurringAmt);
